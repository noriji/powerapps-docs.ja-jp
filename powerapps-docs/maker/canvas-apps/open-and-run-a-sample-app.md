...
このクイックスタートでは、クラウド アカウントに格納された架空のデータを使用するサンプルに基づく独自のアプリを作成しました。 アプリを作成する方法の詳細については、Common Data Service、SharePoint、Excel などの他のソースのデータに基づいてアプリを自動的に生成することもできます。
