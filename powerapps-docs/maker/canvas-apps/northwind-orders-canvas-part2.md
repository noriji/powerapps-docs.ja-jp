...
1. **ツリービュー**ペインで、 **[Screen1]** を選択して、誤って注文ギャラリーにコントロールを追加しないようにします。
    ...
    > [!div class="mx-imgBorder"]
    > ツリービューペインで Screen1 を ![Select ](media/northwind-orders-canvas-part2/titlebar-01.png)

1. **[挿入]** タブで、 **[ラベル]** を選択して[**ラベル**](controls/control-text-box.md)コントロールを挿入します。

    > [!div class="mx-imgBorder"]
    > ラベルを ![Insert ](media/northwind-orders-canvas-part2/titlebar-02.png)
...
1. 画面の上部に表示されるように、新しいラベルを移動してサイズを変更します。
    ...
    > [!div class="mx-imgBorder"]
    > ラベルの ![Move とサイズ変更 ](media/northwind-orders-canvas-part2/titlebar-03.png)
...
1. ラベルのテキストをダブルクリックし、「 **Northwind Orders**」と入力します。
    ...
    > [!div class="mx-imgBorder"]
    > タイトルバーのテキストを ![Change ](media/northwind-orders-canvas-part2/titlebar-04.png)
...
1. **[ホーム]** タブで、次のようにラベルの書式を設定します。
    ...
    > [!div class="mx-imgBorder"]
    > [ホーム] タブの ![Formatting オプション ](media/northwind-orders-canvas-part2/titlebar-05.png)
...
1. **[挿入]** タブで、次のように[**編集フォーム**](controls/control-form-detail.md)コントロールを挿入します。
    ...
    > [!div class="mx-imgBorder"]
    > フォームの編集コントロールを ![Add ](media/northwind-orders-canvas-part2/form-01.png)

    既定では、フォームが左上隅に表示され、他のコントロールが見つけづらくなる可能性があります。

    > [!div class="mx-imgBorder"]
    > 既定の場所にフォームコントロールを ![Edit ](media/northwind-orders-canvas-part2/form-02.png)

1. フォームを移動してサイズを変更すると、タイトルバーの下に画面の右上隅が表示されます。

    > [!div class="mx-imgBorder"]
    > フォームの編集コントロールの ![Move とサイズ変更 ](media/northwind-orders-canvas-part2/form-03.png)
...
1. 数式バーで、フォームの**DataSource**プロパティを次の値に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > フォームの編集コントロールの DataSource プロパティを ![Set ](media/northwind-orders-canvas-part2/form-04.png)
...
1. 右端の近くにある **[プロパティ]** タブで、 **[フィールドの編集]** を選択して **[フィールド]** ウィンドウを開きます。
    ...
    > [!div class="mx-imgBorder"]
    > フィールドウィンドウ ![Open ](media/northwind-orders-canvas-part2/form-05.png)

1. **[フィールド]** ウィンドウで **[フィールドの追加]** を選択し、 **[Customer]** および **[Employee]** フィールドのチェックボックスをオンにします。

    > [!div class="mx-imgBorder"]
    > Customer フィールドと Employee フィールドを編集フォームコントロールに ![Add ](media/northwind-orders-canvas-part2/form-06.png)
...
1. これらのフィールドが表示されるまで下にスクロールし、チェックボックスをオンにします。
    ...
    > [!div class="mx-imgBorder"]
    > フォームの編集コントロールに、さらに5つのフィールドを ![Add ](media/northwind-orders-canvas-part2/form-07.png)
...
1. **フィールド**ウィンドウの下部にある **[追加]** を選択し、 **[フィールド]** ウィンドウを閉じます。
    ...
    > [!div class="mx-imgBorder"]
    > ![Edit フォームコントロールには、7つのフィールドが表示され ](media/northwind-orders-canvas-part2/form-08.png)
...
1. フォームを選択した状態で、右端の近くにある **[プロパティ]** タブで、フォームの列の数を3から12に変更します。
    ...
    > [!div class="mx-imgBorder"]
    > フォームの編集コントロールの列数 ![Change ](media/northwind-orders-canvas-part2/form-08b.png)
...
1. 他のコントロールと同様にハンドルをドラッグして、フィールドの移動とサイズ変更を行います。各行には、これらのデータカードが指定した順序で含まれます。
    ...
    > [!div class="mx-imgBorder"]
    > フィールドの ![Move とサイズ変更 ](media/northwind-orders-canvas-part2/form-rearrange.gif)
...
1. Shift キーを押しながら、 **Order Date**データカードの [時]、[分]、および [コロン区切り] の各コントロールを選択します。
    ...
    > [!div class="mx-imgBorder"]
    > 注文日カードの時刻コントロールを ![Select し ](media/northwind-orders-canvas-part2/form-09.png)
...
1. コントロールの**Visible**プロパティを**false**に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > Visible プロパティを false に ![Set します。](media/northwind-orders-canvas-part2/form-10.png)

1. 日付の[**選択**](controls/control-date-picker.md)コントロールのサイズを変更して、完全な日付を表示します。

    > [!div class="mx-imgBorder"]
    > 日付の選択コントロールを ![Resize し ](media/northwind-orders-canvas-part2/form-11.png)
...
1. **[ツリービュー]** ウィンドウで、 **[有料日付]** データカードの時間コントロールを選択します。
    ...
    > [!div class="mx-imgBorder"]
    > 有料の日付カードの ![Select 時間制御 ](media/northwind-orders-canvas-part2/form-12.png)

1. 選択したコントロールの**Visible**プロパティを**false**に設定します。

    > [!div class="mx-imgBorder"]
    > Visible プロパティを false に ![Set します。](media/northwind-orders-canvas-part2/form-13.png)

1. **クレジット**カードの日付の選択のサイズを変更します。

    > [!div class="mx-imgBorder"]
    > 日付の選択コントロールを ![Resize し ](media/northwind-orders-canvas-part2/form-14.png)
...
1. 概要フォームの**Item**プロパティを次の式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > フォーム ](media/northwind-orders-canvas-part2/form-15.png) の ![Set Item プロパティ

    このフォームには、アプリのユーザーが一覧で選択した順序の概要が表示されます。

    > [!div class="mx-imgBorder"]
    > 一覧の順序を ![Select して、フォームに概要を表示 ](media/northwind-orders-canvas-part2/form-select.gif)
...
1. フォームを選択し、右端の **[プロパティ]** タブで **[フィールドの編集]** を選択し、 **[Order number]** フィールドを選択します。
    ...
    > [!div class="mx-imgBorder"]
    > 注文番号フィールドを ![Select ](media/northwind-orders-canvas-part2/alt-01.png)

1. コントロールの**種類**の一覧を開きます。

    > [!div class="mx-imgBorder"]
    > \* * コントロール型 * * リストを ![Open ](media/northwind-orders-canvas-part2/alt-02.png)

1. [テキストデータの**表示**] カードを選択します。

    > [!div class="mx-imgBorder"]
    > ![Select * * 表示テキスト * * データカード ](media/northwind-orders-canvas-part2/alt-02b.png)
...
1. **[フィールド]** ウィンドウを閉じます。
    ...
    > [!div class="mx-imgBorder"]
    > ![Order 番号は読み取り専用 ](media/northwind-orders-canvas-part2/alt-03.png)

1. **[ホーム]** タブで、順序番号のフォントサイズを20ポイントに変更して、フィールドを見つけやすくします。

    > [!div class="mx-imgBorder"]
    > 注文番号のフォントサイズを ![Change ](media/northwind-orders-canvas-part2/alt-04.png)
...
1. [ **Employee** data] カードを選択します。
    ...
    > [!div class="mx-imgBorder"]
    > 従業員データカードを ![Select ](media/northwind-orders-canvas-part2/employee-01.png)

1. 右端の近くにある **[詳細設定**] タブで、データカードのロックを解除して、以前に読み取り専用であった数式を編集できるようにします。

    > [!div class="mx-imgBorder"]
    > 従業員データカードを ![Unlock ](media/northwind-orders-canvas-part2/employee-02.png)

1. データカードで、次のように、コンボボックスの幅を狭くして、従業員の写真用の領域を確保します。

    > [!div class="mx-imgBorder"]
    > コンボボックスコントロールを ![Resize ](media/northwind-orders-canvas-part2/employee-03b.png)

1. **[挿入]** タブで、[**メディア** > **イメージ**] を選択します。

    > [!div class="mx-imgBorder"]
    > イメージ ](media/northwind-orders-canvas-part2/employee-04.png) を ![Insert する

    画像がデータカードに表示され、それに合わせて拡大されます。

    > [!div class="mx-imgBorder"]
    > Image コントロールを使用してデータカードを ![Employee ](media/northwind-orders-canvas-part2/employee-05.png)

1. イメージのサイズを変更し、コンボボックスの右側に移動します。

    > [!div class="mx-imgBorder"]
    > イメージコントロールの ![Move とサイズ変更 ](media/northwind-orders-canvas-part2/employee-06.png)
...
1. 画像の**image**プロパティを次の数式に設定します。必要に応じて、Datacシャー値の最後の数値を置き換えます。
    ...
    > [!div class="mx-imgBorder"]
    > イメージの Image プロパティを ![Set ](media/northwind-orders-canvas-part2/employee-07.png)
...
1. Alt キーを押したまま、コンボボックスで別の従業員を選択して、画像も変更されていることを確認します。
    ...
    > [!div class="mx-imgBorder"]
    > 従業員にその従業員の画像を表示する ![Select ](media/northwind-orders-canvas-part2/employee-select.gif)
...
1. **[ツリービュー]** ペインで **[Screen1]** を選択し、[ ** >  アイコン**の**挿入**] を選択し  > **確認**します。
    ...
    > [!div class="mx-imgBorder"]
    > ![Insert チェックマークアイコン ](media/northwind-orders-canvas-part2/save-01.png)

    既定では、[**チェック**](controls/control-shapes-icons.md)アイコンが左上隅に表示されます。他のコントロールでは、アイコンの検索が困難になる場合があります。

    > [!div class="mx-imgBorder"]
    > 既定の場所の ![Icon ](media/northwind-orders-canvas-part2/save-02.png)

1. **[ホーム]** タブで、アイコンの **[色]** プロパティを白に変更し、アイコンのサイズを変更して、タイトルバーの右端近くに移動します。

    > [!div class="mx-imgBorder"]
    > 保存アイコンの色、サイズ、および場所を ![Configure ](media/northwind-orders-canvas-part2/save-03.png)
...
1. **ツリービュー**ペインで、フォームの名前が**Form1**であることを確認し、アイコンの**onselect**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > 保存アイコンの OnSelect プロパティを ![Set ](media/northwind-orders-canvas-part2/save-04.png)
...
1. アイコンの**DisplayMode**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > アイコンの DisplayMode プロパティを ![Set ](media/northwind-orders-canvas-part2/save-05.png)
...
1. アイコンの**DisabledColor**プロパティを次の値に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > アイコンの DisabledColor プロパティを ![Set ](media/northwind-orders-canvas-part2/save-06.png)

    ユーザーは、チェックアイコンを選択して、注文への変更を保存できます。このアイコンは、ユーザーが別の変更を行うまで無効になり、淡色表示になります。

    > [!div class="mx-imgBorder"]
    > 変更の ![saving ](media/northwind-orders-canvas-part2/save-submit.gif)
...
1. **[挿入]** タブで、[**アイコン** > **キャンセル**する] を選択します。
    ...
    > [!div class="mx-imgBorder"]
    > ![Add キャンセル アイコン ](media/northwind-orders-canvas-part2/save-07.png)

    既定では、アイコンが左上隅に表示されます。他のコントロールでは、アイコンの検索が困難になる場合があります。

    > [!div class="mx-imgBorder"]
    > 既定の場所の ![Cancel アイコン ](media/northwind-orders-canvas-part2/save-08.png)

1. **[ホーム]** タブで、アイコンの **[色]** プロパティを白に変更し、アイコンのサイズを変更して、チェックアイコンの左側に移動します。

    > [!div class="mx-imgBorder"]
    > [キャンセル] アイコンの色、サイズ、および位置を ![Change ](media/northwind-orders-canvas-part2/save-09.png)
...
1. キャンセルアイコンの**Onselect**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > キャンセルアイコンの OnSelect プロパティを ![Set ](media/northwind-orders-canvas-part2/save-10.png)
...
1. 取り消しアイコンの**DisplayMode**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > キャンセルアイコンの DisplayMode プロパティを ![Set ](media/northwind-orders-canvas-part2/save-11.png)
...
1. キャンセルアイコンの**DisabledColor**プロパティを次の値に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > キャンセルアイコンの DisabledColor プロパティを ![Set ](media/northwind-orders-canvas-part2/save-12.png)

    ユーザーは注文に対する変更を取り消すことができ、すべての変更が保存されている場合、[確認] および [キャンセル] アイコンは無効になり、淡色表示になります。

    > [!div class="mx-imgBorder"]
    > 変更の ![Saving と取り消し ](media/northwind-orders-canvas-part2/save-cancel.gif)
...
1. **[挿入]** タブで、 **[追加]**  >  **[アイコン]** を選択します。
    ...
    > [!div class="mx-imgBorder"]
    > [追加] アイコンを ![Insert ](media/northwind-orders-canvas-part2/save-13.png)

    既定では、 **[追加]** アイコンが左上隅に表示されます。他のコントロールでは、検索が困難になる場合があります。

    > [!div class="mx-imgBorder"]
    > [追加] アイコンの ![Default の場所 ](media/northwind-orders-canvas-part2/save-14.png)

1. **ホーム** タブで、追加 アイコンの **色** プロパティを白に設定し、アイコンのサイズを変更して、キャンセル アイコンの左側に移動します。

    > [!div class="mx-imgBorder"]
    > [追加] アイコンの色、サイズ、および位置を ![Change ](media/northwind-orders-canvas-part2/save-15.png)
...
1. 追加アイコンの**Onselect**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > [追加] アイコンの OnSelect プロパティを ![Set ](media/northwind-orders-canvas-part2/save-15b.png)
...
1. 追加 アイコンの  **DisplayMode** プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > [追加] アイコンの [DisplayMode] プロパティを ![Set ](media/northwind-orders-canvas-part2/save-16.png)
...
1. [追加] アイコンの**DisabledColor**プロパティを次の値に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > ![Set 追加アイコンの DisabledColor プロパティ ](media/northwind-orders-canvas-part2/save-17.png)
    ...
    > [!div class="mx-imgBorder"]
    > 注文 ](media/northwind-orders-canvas-part2/save-new.gif) を ![Create する
...
1. **[挿入]** タブで、[**アイコン** > **ごみ箱**] を選択します。
    ...
    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンを ![Insert ](media/northwind-orders-canvas-part2/save-18.png)

    既定では、**ごみ箱**アイコンが左上隅に表示されます。他のコントロールでは、検索が困難になる場合があります。

    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンの ![Default の場所 ](media/northwind-orders-canvas-part2/save-19.png)

1. **[ホーム]** タブで、ごみ箱アイコンの**Color**プロパティを白に変更し、アイコンのサイズを変更して、[追加] アイコンの左側に移動します。

    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンの色、サイズ、および位置を ![Change ](media/northwind-orders-canvas-part2/save-20.png)
...
1. ごみ箱アイコンの**Onselect**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンの OnSelect プロパティを ![Set ](media/northwind-orders-canvas-part2/save-21.png)
...
1. ごみ箱アイコンの**DisplayMode**プロパティを次の数式に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンの DisplayMode プロパティを ![Set ](media/northwind-orders-canvas-part2/save-22.png)
...
1. ごみ箱アイコンの**DisabledColor**プロパティを次の値に設定します。
    ...
    > [!div class="mx-imgBorder"]
    > ごみ箱アイコンの DisabledColor プロパティを ![Set ](media/northwind-orders-canvas-part2/save-23.png)
