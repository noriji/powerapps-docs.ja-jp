---
title: 独自のガイド付きヘルプを作成する (ラーニング パス) (モデル駆動型のアプリケーション) | MicrosoftDocs
description: ''
keywords: null
ms.date: 04/30/2019
...
1. 管理者アカウントを使用して [PowerApps](https://web.powerapps.com/?utm_source=padocs&utm_medium=linkinadoc&utm_campaign=referralsfromdoc) または [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] にサインインします。  
...
## <a name="learning-path-and-common-data-service-security-roles"></a>ラーニング パスおよび Common Data Service のセキュリティ ロール 
...
4. あなたの Common Data Service セキュリティ ロールとそのセキュリティ ロールを同期するには、**ロールの同期**を選択します。  
...
-   サイト マップで**トレーニング**タイルを選び、**コンテンツ ライブラリ**を選択します。  
     ...
     ![モデル駆動型のアプリケーションのサイトマップ上のコンテント ライブラリ アイコン](media/lp-sitemap-content-library.png "モデル駆動型のアプリケーションのサイトマップ上のコンテント ライブラリ アイコン")  
